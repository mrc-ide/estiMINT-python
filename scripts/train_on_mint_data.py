"""
Retrain estiMINT using MINTelligence data.

This script:
1. Loads the prepared data from prepare_mint_data.py
2. Trains XGBoost model using K-fold CV and QMAP calibration
3. Saves model to output/mint_retrained/
"""
...
# Configuration
DATA_PATH = "/home/cosmo/Documents/Repos/estimint/output/mint_data/mint_training_data.csv"
OUTPUT_DIR = "/home/cosmo/Documents/Repos/estimint/output/mint_retrained"
K_FOLDS = 10
K_STRATA = 16
SEED = 42
...
def main():
    print("=" * 80)
    print("Training estiMINT on MINTelligence Data")
    print("=" * 80)
    ...
    if not data_path.exists():
        ...
        print("Please run prepare_mint_data.py first")
        return 1
    ...
    plot_obs_pred(
        ...
        f"EIR — Observed vs Predicted (XGBoost, K={K_FOLDS} CV, QMAP+Scale, test)",
    ...
    preprocess = {
        ...
        "training_data": {
            "source": "MINTelligence malaria_simulations_4096.duckdb",
            "n_rows": len(DT),
    ...
    print("=" * 80)
    print(f"\nModel saved to: {dir_models}/estiMINT_model.pkl")
    print(f"Plots saved to: {dir_plots}/")
    print(f"Metrics saved to: {dir_metric}/")

    print("\n=== Next Steps ===")
    print("To test the new model:")
    print(f"  export ESTIMINT_MODELS_DIR={dir_models}")
    print("  cd /home/cosmo/Documents/Repos/MINTelligence/tst")
    print("  python API_check.py")
    print("\nTo compare with old model:")
    print("  unset ESTIMINT_MODELS_DIR")
    print("  python API_check.py")
